...
import { BarChart2, Coffee, ClipboardList, Layers, Users, Settings, LogOut, Menu, X, Blend, ListChecks, ShoppingBag, UserCog } from 'lucide-react';

const NAV = [
  { href: '/admin/dashboard', label: 'Dashboard', icon: BarChart2 },
  { href: '/admin/menu', label: 'Thực đơn', icon: Coffee },
  { href: '/admin/orders', label: 'Đơn hàng', icon: ClipboardList },
  { href: '/admin/sales', label: 'Bán chạy', icon: ShoppingBag },
